  ...
  return (
    ...
    <section className={"relative"}>
      ...
      <div className="container">
        <section className="relative z-10 grid place-items-center py-32">
          <article className="text-center ">
            <h2 style={font.style} className="text-white text-4xl md:text-5xl">
              Get started today
            </h2>
            <p className="text-white my-6 max-w-md text-md md:text-lg ">
