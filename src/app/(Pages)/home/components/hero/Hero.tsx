          ...
          <article className={`${s.content} py-32 sm:py-44`}>
            ...
            >
              ...
              >
                ...
                <motion.span
                  className="relative z-20 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500"
                  animate={{
                    color: [
            ...
            >
              ...
              <Button
                ...
                className="shadow-sm bg-white border-1 border-slate-200 rounded-full text-white font-extrabold hover:bg-purple-700 transition-all duration-300"
                as={Link}
              >
