...
export const Hero: FC = ({}) => {
  return (
    <section className={`${s.hero} py-32`}>
      <div className="container">
        <section className={s.wrapper}>
          <article>
            <h1
              style={font.style}
              className="relative text-black mx-auto max-w-4xl tracking-tight"
            >
              Accounting{" "}
              <span className="relative whitespace-nowrap lg:whitespace-normal">
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
                  className="absolute left-0 top-2/3 h-[0.58em] w-full fill-blue/30"
            ...
            <div className={`${s.actions} mt-6`}>
              <ButtonLink
                ...
                styles=" bg-black text-white font-medium rounded-full mr-5"
                href=""
              />
              <Button
                target="blank"
                href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"
                className="bg-white border-1 border-slate-200 rounded-full text-black font-medium"
                as={Link}
              >
